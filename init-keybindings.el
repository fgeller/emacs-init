...
(define-key fg-map "ld"		(make-repeatable-command 'duplicate-line))
...
(define-key fg-map "^"		(make-repeatable-command 'join-line))
(define-key fg-map "%"		(make-repeatable-command 'goto-match-paren))
