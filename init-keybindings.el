...
(define-key fg-map "d"		'duplicate-line)
(define-key fg-map "eb"		'ediff-buffers)
(define-key fg-map "el"		'ediff-regions-linewise)
(define-key fg-map "ew"		'ediff-regions-wordwise)
(define-key fg-map "ef"		'ediff-files)
